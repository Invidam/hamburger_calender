...
},{"./cjs/react-dom.production.min.js":"i17t"}],"27o/":[function(require,module,exports) {
var e=[],t=[],r="insert-css: You need to provide a CSS string. Usage: insertCss(cssString[, options]).";function n(n,o){if(o=o||{},void 0===n)throw new Error(r);var d,i=!0===o.prepend?"prepend":"append",p=void 0!==o.container?o.container:document.querySelector("head"),c=e.indexOf(p);return-1===c&&(c=e.push(p)-1,t[c]={}),void 0!==t[c]&&void 0!==t[c][i]?d=t[c][i]:(d=t[c][i]=s(),"prepend"===i?p.insertBefore(d,p.childNodes[0]):p.appendChild(d)),65279===n.charCodeAt(0)&&(n=n.substr(1,n.length)),d.styleSheet?d.styleSheet.cssText+=n:d.textContent+=n,d}function s(){var e=document.createElement("style");return e.setAttribute("type","text/css"),e}module.exports=n,module.exports.insertCss=n;
},{}],"cGNa":[function(require,module,exports) {
"use strict";function e(e){for(var r=new Array(e),t=0;t<e;t++)r[t]=t+1;return r}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=e;
},{}],"AYA6":[function(require,module,exports) {
"use strict";var e=this&&this.__extends||function(){var e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var r in t)t.hasOwnProperty(r)&&(e[r]=t[r])};return function(t,r){function n(){this.constructor=t}e(t,r),t.prototype=null===r?Object.create(r):(n.prototype=r.prototype,new n)}}(),t=this&&this.__assign||Object.assign||function(e){for(var t,r=1,n=arguments.length;r<n;r++)for(var o in t=arguments[r])Object.prototype.hasOwnProperty.call(t,o)&&(e[o]=t[o]);return e},r=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var r in e)Object.hasOwnProperty.call(e,r)&&(t[r]=e[r]);return t.default=e,t},n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});var o=r(require("react")),a=n(require("./starRange")),i=5,s=function(r){function n(e){var t=r.call(this,e)||this;return t._promiseSetStateDone=Promise.resolve(),t.state={prospectiveValue:0},t}return e(n,r),Object.defineProperty(n.prototype,"promiseSetStateDone",{get:function(){return this._promiseSetStateDone},enumerable:!0,configurable:!0}),n.prototype.render=function(){var e=this,r=a.default(this.props.size?this.props.size:i);return o.createElement("div",{className:"star-rating-input"},o.createElement(u,{onClick:this.handleStarClick.bind(this,0)}),r.map(function(r){return o.createElement(c,t({},e.starProps(r),{key:r}))}))},n.prototype.starProps=function(e){return{value:e,mode:this.anchorMode(e),onClick:this.handleStarClick.bind(this,e),onMouseEnter:this.handleStarMouseEnter.bind(this,e),onMouseLeave:this.handleStarMouseLeave.bind(this,e)}},n.prototype.anchorMode=function(e){return this.state.prospectiveValue>0?e<=this.state.prospectiveValue?"suggested":"off":e<=this.props.value?"on":"off"},n.prototype.handleStarMouseEnter=function(e){var t=this;this._promiseSetStateDone=new Promise(function(r){t.setState({prospectiveValue:e},r)})},n.prototype.handleStarMouseLeave=function(e){var t=this;this._promiseSetStateDone=new Promise(function(e){t.setState({prospectiveValue:0},e)})},n.prototype.handleStarClick=function(e){var t=this;this._promiseSetStateDone=new Promise(function(e){t.setState({prospectiveValue:0},e)}),this.props.onChange(e)},n}(o.Component);function u(e){return o.createElement("div",{className:"star-rating-clear-container"},o.createElement("a",{className:"star-rating-clear",href:"",title:"0",onClick:function(t){t.preventDefault(),e.onClick()}},"•"))}function c(e){return o.createElement("div",{className:"star-rating-star-container"},o.createElement("a",{className:"star-rating-star "+e.mode,title:""+e.value,href:"",onMouseEnter:e.onMouseEnter,onMouseLeave:e.onMouseLeave,onClick:function(t){t.preventDefault(),e.onClick()}}))}exports.default=s;
},{"react":"1n8/","./starRange":"cGNa"}],"MLhP":[function(require,module,exports) {
"use strict";var e=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var r in e)Object.hasOwnProperty.call(e,r)&&(t[r]=e[r]);return t.default=e,t},t=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});var r=e(require("react")),a=t(require("./starRange"));function n(e){return r.createElement("div",{className:"star-rating-input"},a.default(e.value).map(function(e){return r.createElement(u,{key:e})}))}function u(){return r.createElement("div",{className:"star-rating-star-container"},r.createElement("a",{className:"star-rating-star on",href:"",onClick:function(e){e.preventDefault()}}))}exports.default=n;
},{"react":"1n8/","./starRange":"cGNa"}],"ahFa":[function(require,module,exports) {
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var r=require("./StarRatingInput");exports.StarRatingInput=r.default,exports.StarRatingInputProps=r.Props;var t=require("./StarRating");exports.StarRating=t.default,exports.StarRatingProps=t.Props;var e=require("./css");exports.css=e.default;
},{"./StarRatingInput":"AYA6","./StarRating":"MLhP","./css":"ahFa"}],"cywG":[function(require,module,exports) {
"use strict";var e=this&&this.__extends||function(){var e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var n in t)t.hasOwnProperty(n)&&(e[n]=t[n])};return function(t,n){function r(){this.constructor=t}e(t,n),t.prototype=null===n?Object.create(n):(r.prototype=n.prototype,new r)}}(),t=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)Object.hasOwnProperty.call(e,n)&&(t[n]=e[n]);return t.default=e,t},n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});var r=t(require("react")),a=t(require("react-dom")),o=n(require("insert-css")),i=require("./index"),u=function(t){function n(e){var n=t.call(this,e)||this;return n.handleChange=n.handleChange.bind(n),n.state={value:0},n}return e(n,t),n.prototype.render=function(){return r.createElement("div",null,r.createElement("h2",null,"Interactive input"),r.createElement(i.StarRatingInput,{size:5,value:this.state.value,onChange:this.handleChange}),r.createElement("br",null),r.createElement("h2",null,"Static display"),r.createElement(i.StarRating,{value:4}))},n.prototype.handleChange=function(e){this.setState({value:e})},n}(r.Component);o.default(i.css),a.render(r.createElement(u,null),document.getElementById("root"));
},{"react":"1n8/","react-dom":"NKHc","insert-css":"27o/","./index":"7QCb"}]},{},["cywG"], null)